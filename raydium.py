...
def buy(client, payer_keypair, pair_address: str, amount_in_sol: float):
    ...
    close_account_instructions = close_account(CloseAccountParams(CONSTANTS.TOKEN_PROGRAM_ID, wsol_token_account, payer_keypair.pubkey(), payer_keypair.pubkey()))
...
def sell(client, payer_keypair, pair_address: str, amount_in_lamports: int):
